	...
	<div class="container">
			...
			<div class="header-top">
				...
				<div>
					...
					<div class="page-title">
						...
						<span>⚙️</span> <span>모임 관리</span> <span class="role-badge">모임장</span>
		...
		<div class="section">
			...
			<div class="management-grid">
				...
				<div class="management-card" onclick="goToMemberManagement()">
					...
					<div class="card-description">모임원 목록 조회, 강제 퇴장, 출석률 확인 등 모임원을
						관리합니다.</div>
				...
				<div class="management-card" onclick="goToApplicationManagement()">
					...
					<div class="card-description">가입 신청자의 정보를 확인하고 승인/거절을 처리합니다.
				...
				<div class="management-card" onclick="goToAttendanceManagement()">

					<div class="card-icon">📋</div>

					<div class="card-title">출석 관리</div>

					<div class="card-description">모임원의 출석/결석을 체크하고 출석률을 관리합니다.</div>
				...
				<div class="management-card" onclick="goToRoleManagement()">
					...
					<div class="card-description">부모임장과 도우미를 지정하여 권한을 부여합니다.</div>
		...
		<div class="section">
			...
			<div class="management-grid">
				...
				<div class="management-card" onclick="goToVoteManagement()">
					...
					<div class="card-description">정기/비정기 모임 투표를 생성하고 결과를 확인합니다.</div>
				...
				<div class="management-card" onclick="goToChallengeManagement()">
					...
					<div class="card-description">도전과제를 생성하고 참가자의 달성률을 확인합니다.</div>
				...
				<div class="management-card" onclick="goToPostManagement()">
					...
					<div class="card-description">부적절한 게시글과 댓글을 삭제하고 공지를 고정합니다.</div>
		...
		<div class="section">
			...
			<div class="management-grid">
				...
				<div class="management-card" onclick="goToGroupEdit()">

					<div class="card-icon">✏️</div>

					<div class="card-title">모임 정보 수정</div>

					<div class="card-description">모임 이름, 설명, 규칙, 난이도 등 기본 정보를
						수정합니다.</div>
				...
				<div class="management-card" onclick="transferLeader()">
					...
					<div class="card-description">다른 모임원에게 모임장 권한을 이양합니다. (되돌릴 수
						없음)</div>
		...
		<div class="danger-zone">
			...
			<div class="danger-title">
				...
				<span>⚠️</span> <span>위험 영역</span>

			</div>

			<div class="danger-description">아래 작업은 되돌릴 수 없습니다. 신중하게 결정해주세요.

			</div>

			<button class="btn-danger" onclick="closeGroup()">🗑️ 모임 폐쇄

			</button>

			<p style="font-size: 13px; color: #999; margin-top: 10px;">모임 폐쇄
				시 모든 모임원이 탈퇴 처리되며, 게시글과 활동 내역은 삭제됩니다.</p>
