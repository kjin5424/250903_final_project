	        ...
	        <div class="content-section">
	            <div id="members-tab" class="tab-content active">
	                <div class="stats-grid">
	                    ...
	                    <div class="stat-card"><div class="stat-value">10</div><div class="stat-label">${groupDetail.maxCount }</div></div>
	                </div>
	            ...
	            <div class="member-info">
	                <div class="member-name">
	                    ...
	                    <c:if test="${member.position eq '모임장'}">
	                        <span class="member-role role-leader">👑 ${member.position}</span>
	                    </c:if>
	                    <c:if test="${member.position eq '부모임장'}">
	                        <span class="member-role role-subleader">⭐ ${member.position}</span>
	                    </c:if>
	                </div>
