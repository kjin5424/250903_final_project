    ...
    <div class="container">
        ...
        <div class="page-header">
            ...
            <div class="header-description">
                부적절한 게시글이나 사용자를 신고할 수 있습니다.<br>
                신고 내용은 관리자가 검토하여 조치합니다.
            </div>
        </div>
        ...
        <form class="report-form" onsubmit="return validateForm()" method="post" action="reportSubmit.action">
            ...
            <div class="form-section">
                ...
                <div class="target-info">
                    <div class="target-item">
                        <span class="target-label">대상 유형:</span>
                        <span class="target-value">게시글</span>
                    </div>
                    <div class="target-item">
                        <span class="target-label">작성자:</span>
                        <span class="target-value">알고리즘초보</span>
                    </div>
                    <div class="target-item">
                        <span class="target-label">제목:</span>
                        <span class="target-value">DP 문제 접근 방법 질문드립니다</span>
                    </div>
                    <div class="target-item">
                        <span class="target-label">작성일:</span>
                        <span class="target-value">2024.10.25 14:30</span>
                    </div>
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="report-type-grid">
                    <div class="report-type-option">
                        <input type="radio" id="type1" name="reportType" value="spam">
                        <label class="report-type-label" for="type1">음란성/선정적 내용</label>
                    </div>
                    <div class="report-type-option">
                        <input type="radio" id="type2" name="reportType" value="abuse">
                        <label class="report-type-label" for="type2">폭력/유해한 내용</label>
                    </div>
                    <div class="report-type-option">
                        <input type="radio" id="type3" name="reportType" value="sexual">
                        <label class="report-type-label" for="type3">광고/홍보/스팸</label>
                    </div>
                    <div class="report-type-option">
                        <input type="radio" id="type4" name="reportType" value="illegal">
                        <label class="report-type-label" for="type4">거짓정보/허위사실 유포</label>
                    </div>
                    <div class="report-type-option">
                        <input type="radio" id="type5" name="reportType" value="fraud">
                        <label class="report-type-label" for="type5">타인 비방/명예 훼손</label>
                    </div>
                    <div class="report-type-option">
                        <input type="radio" id="type6" name="reportType" value="copyright">
                        <label class="report-type-label" for="type6">저작권 침해</label>
                    </div>
                    <div class="report-type-option">
                        <input type="radio" id="type7" name="reportType" value="privacy">
                        <label class="report-type-label" for="type7">개인정보 노출</label>
                    </div>
                    <div class="report-type-option">
                        <input type="radio" id="type8" name="reportType" value="etc">
                        <label class="report-type-label" for="type8">부적절한 닉네임 또는 프로필 사진</label>
                    </div>
                </div>
            </div>
           ...
           <!--  <div class="form-section">
                ...
                <div class="form-description">
                    신고 사유를 구체적으로 작성해주세요. (최소 10자, 최대 1000자)
                </div>
                <textarea 
                    id="reportContent" 
                    name="reportContent" 
                    rows="8" 
                    placeholder="신고 사유를 상세히 작성해주세요.&#10;예: 해당 게시글은 특정 제품을 홍보하는 광고성 내용으로, 모임 주제와 무관합니다."
