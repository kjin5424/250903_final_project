    ...
    <div class="container">
        ...
        <div class="page-header">
            ...
            <div class="header-description">
                부적절하거나 규정을 위반하는 모임을 신고할 수 있습니다.<br>
        ...
        <form class="report-form" onsubmit="return validateForm()" method="post" action="reportafter.do">
            ...
            <div class="info-box">
                <div class="info-content">
                    💡 모임 신고는 플랫폼 관리자가 검토합니다. 심각한 위반 사항이 확인되면 모임 폐쇄, 모임장 제재 등의 조치가 이루어질 수 있습니다.
                </div>
            </div>
                    ...
                    <div class="group-header-section">
                        ...
                        <div class="group-info">
                            ...
                            <div class="group-meta">
                                <span class="meta-badge">IT</span>
                                <span class="meta-badge">Lv.3</span>
                                <span class="meta-badge">온라인/오프라인</span>
                            </div>
                        </div>
                    </div>
                    <div class="target-item">
                        <span class="target-label">모임장:</span>
                        <span class="target-value">김모임장</span>
                    </div>
                    <div class="target-item">
                        <span class="target-label">개설일:</span>
                        <span class="target-value">2024.08.03</span>
                    </div>
                    <div class="target-item">
                        <span class="target-label">현재 인원:</span>
                        <span class="target-value">7/10명</span>
                    </div>
                    <div class="target-item">
                        <span class="target-label">모임 활동:</span>
                        <span class="target-value">총 45회</span>
                    </div>
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="report-type-grid">
                    <div class="report-type-option">
                        <input type="radio" id="type1" name="reportType" value="fraud">
                        <label class="report-type-label" for="type1">음란성 모임</label>
                    </div>
                    <div class="report-type-option">
                        <input type="radio" id="type2" name="reportType" value="commercial">
                        <label class="report-type-label" for="type2">광고성 모임</label>
                    </div>
                    <div class="report-type-option">
                        <input type="radio" id="type3" name="reportType" value="illegal">
