...
<div class="top-menu-bar">
	<nav class="navbar">
		<div class="nav-left">
			...
			<a href="<%=cp%>/start.do" class="logo-tab"> <span
				class="logo-icon">🎯</span> <span>공모자들</span>
			</a>
			...
			<%-- <a href="?page=creategroup"
				...
				모임 개설 </a>  --%>
			<a href="beforegroupcreate.do"
				class="nav-tab <%="beforecreategroup".equals(currentPage) ? "active" : ""%>">
				모임 개설 </a> <a href="?page=mygroups"
				class="nav-tab <%="mygroups".equals(currentPage) ? "active" : ""%>">
				내 모임 </a> <a href="<%=cp%>/mypage.do"
		...
		<div class="nav-right">
			...
			%>
			<!-- 로그인 버튼 -->
			<a href="loginpage.do" class="user-btn"> <span>🔐</span> <span>로그인</span>
			</a>
			<!-- 프로필 버튼 -->
			...
			%>
			<!-- 로그인 버튼 -->
			<a href="logout.do" class="user-btn"> <span>🔐</span> <span>로그아웃</span>
			</a>
			<!-- 프로필 버튼 -->
			<a href="<%=cp%>/user/Profile/MyProfile.jsp" class="user-btn primary">
