...
<body>
	...
	<div class="login-container">
		...
		<div class="login-box">
			...
			<form action="UserMain.jsp" id="loginForm"
				...
				<button type="submit" class="btn-login">이메일로 비밀번호 전송</button>
			</form>
	...
	<script>
		...
		function validateLogin(event) {
			...
			// 실제로는 서버로 아이디 및 이메일 검증요청
			processFindUserPassword(userId, userEmail);
		...
		// 로그인 처리
		function processFindUserPassword(userId, userEmail) {

			// 일반 사용자 비밀번호 찾기
			if (userId === 'user' && userEmail === 'user123@gmail.com') {
			...
			// 검증 실패
			showError('아이디 또는 이메일이 올바르지 않습니다.');
		}
